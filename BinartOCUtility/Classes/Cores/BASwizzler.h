 ...
 */
+ (BOOL)ba_swizzleMethod:(SEL)originalSelector withMethod:(SEL)newSelector error:(NSError **)error;
+ (BOOL)ba_swizzleClassMethod:(SEL)originalSelector withClassMethod:(SEL)newSelector error:(NSError **)error;
 ...
 */
+ (BOOL)ba_copyMethod:(SEL)newSelector toMethod:(SEL)dstSelector error:(NSError **)error;
+ (BOOL)ba_copyClassMethod:(SEL)newSelector toClassMethod:(SEL)dstSelector error:(NSError **)error;
